...
function startQuiz() {
    ...
    // Mostrar botones de comprobar y siguiente pregunta
    document.getElementById('checkAnswer').style.display = 'block';
    document.getElementById('nextQuestion').style.display = 'none';
    
    // Mostrar barra de progreso y cronómetro
...
function endQuiz() {
    ...
    document.getElementById('score').innerHTML = `
        <p>Tu puntuación es ${score} puntos. (Sobre ${totalQuestions * (totalQuestions === 20 ? 3 : 2)} puntos)</p>
